                        ...
                        <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                            <li>
                                <Link to="/" id="navbar-link-home" 
                                    className={`${currentLocation==="" ? "md:text-blue-700 md:dark:text-blue-500" : ""}
                            ...
                            <li>
                                <Link to="/sobre" id="navbar-link-sobre" 
                                    className={`${currentLocation==="sobre" ? "md:text-blue-700 md:dark:text-blue-500" : ""}
                            ...
                            <li>
                                <Link to="/loja" id="navbar-link-loja"
                                    className={`${currentLocation==="loja" ? "md:text-blue-700 md:dark:text-blue-500" : ""}
                                    block py-2 px-3 rounded-sm md:p-0
                                    text-gray-900 
